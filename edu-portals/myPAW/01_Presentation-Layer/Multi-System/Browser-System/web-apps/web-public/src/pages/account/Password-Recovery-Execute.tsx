...
export default function PasswordRecoveryExecute() {
  const action: PageAction = {
    title: "Password Recovery Execute",
    description: "Set a new password using a secure recovery token.",
    endpoint: "/api/password-recovery-execute"
  };
